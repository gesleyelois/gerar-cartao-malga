...
__export(src_exports, {
  ApiPaginateSort: () => ApiPaginateSort,
  AuthScope: () => AuthScope,
...
${payload}`);
    return import_node_crypto.default.verify(null, data, params.publicKey, signature);
  }
};
...
var _Api = class _Api {
  constructor(configurations) {
    ...
    (0, import_axios_retry.default)(this.api, {
  ...
  handleRetryCondition(error) {
    ...
    if (import_axios_retry.default.isNetworkOrIdempotentRequestError(error) || isUsingIdempotencyKey && isPostMethod) {
      return true;
    }
    return false;
  }
